...
tx_kequestionnaire_domain_model_resultanswer.col as ra_col,
...
(SELECT tx_kequestionnaire_domain_model_answer.type FROM tx_kequestionnaire_domain_model_answer WHERE tx_kequestionnaire_domain_model_resultanswer.answer = tx_kequestionnaire_domain_model_answer.uid) as a_type,
(SELECT tx_kequestionnaire_domain_model_answer.type FROM tx_kequestionnaire_domain_model_answer WHERE tx_kequestionnaire_domain_model_resultanswer.col = tx_kequestionnaire_domain_model_answer.uid) as a_coltype
FROM 

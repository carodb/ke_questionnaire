...
class Dependancy extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity
{
    ...
    public function getJsId()
    {
        ...
        switch ($this->getAnswer()->getShortType()) {
            case 'Radiobutton':
                $js .= 'input[name=\'tx_kequestionnaire_questionnaire[newResult][questions][' . $this->getQuestion()->getUid() . '][answers][' . $this->getQuestion()->getUid() . '][answer]\']';
                break;
            default:
                $js .= 'input[name=\'tx_kequestionnaire_questionnaire[newResult][questions][' . $this->getQuestion()->getUid() . '][answers][' . $this->getAnswer()->getUid() . '][value]\']';
                break;
        }
     ...
     * @return string
     */
    public function getJsIdChecked()
    {
        $js = '';

        switch ($this->getAnswer()->getShortType()) {
            case 'Radiobutton':
                $js .= 'jQuery("input[name=\'tx_kequestionnaire_questionnaire[newResult][questions][' . $this->getQuestion()->getUid() . '][answers][' . $this->getQuestion()->getUid() . '][answer]\']:checked")';
                break;
            default:
                $js .= 'jQuery("input[name=\'tx_kequestionnaire_questionnaire[newResult][questions][' . $this->getQuestion()->getUid() . '][answers][' . $this->getAnswer()->getUid() . '][value]\']:checked")';
                break;
        }

...
class ExportController extends \Kennziffer\KeQuestionnaire\Controller\BackendController
{
    ...
    public function createPdf($resultId = NULL, $compared = false)
    {
        ...
        //\TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump($this->plugin, 'plugin');
        //\TYPO3\CMS\Extbase\Utility\DebuggerUtility::var_dump($this->request->getArguments(), 'args');

        //the tsfe data is needed
        $this->backendTsfe->buildTSFE($this->plugin['pid']);

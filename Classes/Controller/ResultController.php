...
#                ));
                ...
                // AST: Hotfix for hardcoded template
                $extbaseFrameworkConfiguration = $this->configurationManager->getConfiguration(\TYPO3\CMS\Extbase\Configuration\ConfigurationManagerInterface::CONFIGURATION_TYPE_FRAMEWORK);
                $templateRootPaths = \TYPO3\CMS\Extbase\Utility\ArrayUtility::sortArrayWithIntegerKeys($extbaseFrameworkConfiguration['view']['templateRootPaths']);
                $templateRootPaths = array_reverse($templateRootPaths, TRUE);

                foreach($templateRootPaths as $path) {
                    if (\TYPO3\CMS\Core\Utility\GeneralUtility::getFileAbsFileName($path) != '') {
                ...
                $this->view->setTemplatePathAndFilename(\TYPO3\CMS\Core\Utility\GeneralUtility::getFileAbsFileName(
                    \TYPO3\CMS\Core\Utility\GeneralUtility::getFileAbsFileName(
                        $templateRootPath . 'Result/End.html'
                    )
                ));
